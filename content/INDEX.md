...
| 2026-09-19 | `fewer-certainties` | Seniority isn't knowing more — it's needing fewer certainties before you act, and knowing which one you still need | LI · IG | — | SHIP |
| 2026-09-17 | `certificate-calendar-invite` | Certificate expiry is an outage with a calendar invite you declined — nobody owns certificates as a category | LI · IG | — | SHIP |
| 2026-09-15 | `intermittent-every-47-minutes` | The "intermittent" that fired every 47 minutes — intermittent is a confession about the window, not a property of the fault | LI · IG | — | SHIP |
| 2026-09-12 | `stopped-saying-low-risk` | I've stopped saying "low risk" — it's a feeling compressed into two words; name what specifically breaks | LI · IG | — | SHIP |
| 2026-09-10 | `status-update-stops-calls` | The status update that stops the calls — four lines, on a clock, with no speculation in them | LI · IG | — | SHIP |
| 2026-09-08 | `layer-1-is-the-answer` | Layer 1 is still the answer more often than we admit — we reach past it because the hard problem flatters us | LI · IG | — | SHIP |
