...
| 2026-10-02 | `monitoring-bill-scales` | Your monitoring bill scales with data, not insight — collecting more is easy, deciding what not to collect is the engineering | LI · FB · IG · X | — | SHIP |
| 2026-09-30 | `8021x-fails-at-the-printer` | 802.1X fails at the printer, not the laptop — NAC rollouts die in the exceptions, so design the exception process first | LI · FB · IG · X | — | SHIP |
| 2026-09-27 | `cheapest-bid-loses-decade` | The cheapest bid wins the project and loses the decade — cost per year of ownership is the only number that survives operations | LI · FB · IG · X | — | SHIP |
| 2026-09-25 | `contracts-and-devices` | Forty-two support contracts, thirty-one devices — six years of ordinary decisions and nothing that reconciled them | LI · FB · IG · X | — | SHIP |
| 2026-09-23 | `wan-queuing-decision` | Your WAN doesn't need more bandwidth — it needs a queuing decision somebody actually made | LI · FB · IG · X | — | SHIP |
| 2026-09-20 | `same-rfc1918-space` | Both networks used the same RFC1918 space — the integration plan was an addressing plan with somebody else's deadline | LI · FB · IG · X | — | SHIP |
