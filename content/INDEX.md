...
|------|------|----------------|---------|--------|--------|
| 2026-09-18 | `supportable-at-3am` | 5 things that make a network supportable at 3am — none of them are products | LI · FB · IG · X | — | SHIP |
| 2026-09-16 | `firewall-rule-nobody-deletes` | Nobody has ever been promoted for deleting a firewall rule — rule bases only grow because the incentive is one-sided | LI · FB · IG · X | — | SHIP |
| 2026-09-13 | `cutover-nobody-rehearsed` | Every project fails at the same milestone — the cutover is the only integration test, and it runs once, in production | LI · FB · IG · X | — | SHIP |
| 2026-09-11 | `outsourcing-isnt-accountability` | You can outsource the work, not the consequence — the question isn't what you hand over, it's what you keep | LI · FB · IG · X | — | SHIP |
| 2026-09-09 | `segment-iot-without-forklift` | Segmenting IoT doesn't need a forklift — thirty days, routed VLANs, and access lists you already own | LI · FB · IG · X | — | SHIP |
| 2026-09-06 | `bandwidth-graph-lies` | Your bandwidth graph lies — a five-minute average can't show the burst that filled the buffer | LI · FB · IG · X | — | SHIP |
