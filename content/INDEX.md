...
| 2026-10-03 | `on-call-makes-careers` | On-call is where careers are actually made — it's a real cost and the fastest place judgment gets built; we only say the first | LI · IG | — | SHIP |
| 2026-10-01 | `handoff-that-survives` | Incidents die at handoff more often than at diagnosis — current state, what's ruled out, what you'd try next | LI · IG | — | SHIP |
| 2026-09-29 | `the-mtu-week` | The MTU problem that took a week — "some things work" is a stronger clue than "nothing works," and we treat it as weaker | LI · IG | — | SHIP |
| 2026-09-26 | `nobody-knew-it-was-broken` | What's the last thing you fixed that nobody knew was broken? Prevention is invisible by construction | LI · IG | — | SHIP |
| 2026-09-24 | `llm-config-operationally-wrong` | It passed lint, it passed review, it failed at 400 devices — review the premises, not the punctuation | LI · IG | — | SHIP |
| 2026-09-22 | `check-both-directions` | Check both directions before you blame either — one-way evidence produces one-way conclusions | LI · IG | — | SHIP |
