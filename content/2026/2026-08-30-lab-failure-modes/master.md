# Master — lab-failure-modes

**Preset:** Business (MZS company account — LI page, FB, IG, X)
**Date:** 2026-08-30 (Sun)
**Source idea:** ideas-2026-07-16 #10 (NetDevOps · Reframe)
**Thesis:** A lab doesn't need to match production. It needs to match production's failure modes.
