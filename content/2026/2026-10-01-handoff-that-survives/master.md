# Master — handoff-that-survives

**Preset:** Professional (LinkedIn personal + Instagram @mzsnetworks)
**Date:** 2026-10-01 (Thu)
**Source idea:** ideas-2026-08-27 #27
**Thesis:** Incidents die at handoff more often than at diagnosis. Three fields carry the state that matters.
**Note:** distinct from `status-update-stops-calls` (2026-09-10), which is the outward update to people waiting. This is engineer-to-engineer transfer.
**Stats:** none — craft/judgment post, no factcheck gate.
