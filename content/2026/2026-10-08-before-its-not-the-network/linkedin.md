# LinkedIn — before-its-not-the-network
...
Can I reproduce it from somewhere else? One client with a problem and every client with a problem are different incidents with different causes, and the difference takes ninety seconds to establish.

What do the counters actually say, at both ends? Not whether the interface is up. Errors, discards, light levels, and whether any of it is moving right now. An interface can be up and unhealthy for months.
...
Which of these has caught you out?
