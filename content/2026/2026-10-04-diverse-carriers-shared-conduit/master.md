# Master — diverse-carriers-shared-conduit

**Preset:** Business (LinkedIn company page + Facebook + Instagram + X, all on the MZS account)
**Date:** 2026-10-04
**Thesis:** Carrier diversity is a contract property. Path diversity is a physical one. Most "redundant" WANs buy the first and assume the second, and the assumption holds until a backhoe finds the one conduit both circuits share.
**Pillar:** Enterprise Network Operations — WAN
**Source:** ideas-2026-08-30 #12
**Stats:** none. The post is judgment and field experience; no statistic is stated as fact, so Factcheck passes with no source gate.
