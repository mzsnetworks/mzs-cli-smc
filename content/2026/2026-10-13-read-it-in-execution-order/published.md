# Published — read-it-in-execution-order

**Preset:** Professional — LinkedIn **personal profile** (Blotato account `26694`, **no `pageId`**) + Instagram @mzsnetworks (`55865`).
**Scheduled:** Tue Oct 13 (2026-10-13) at 4:00 PM EDT (`2026-10-13T20:00:00Z`) on both platforms.
...
|------------|----------|--------|-------|---------------|--------|
| 2026-10-13T20:00:00Z | LinkedIn (personal) | `linkedin.md` | hero 16:9 | `6cf1aa08-24f7-44d7-b306-8793362d6607` | SCHEDULED |
| 2026-10-13T20:00:00Z | Instagram @mzsnetworks | `instagram.md` | hero 4:5 | `19e5449a-fd81-4203-8b4b-d3711c2ac5c9` | SCHEDULED |
