# Master — bandwidth-graph-lies

**Preset:** Business (MZS company account — LI page, FB, IG, X)
**Date:** 2026-09-06 (Sun)
**Source idea:** ideas-2026-08-09 #8 (ENO · Observation)
**Thesis:** A five-minute average cannot show a millisecond burst. The graph is calm because the sampling is.
**Stats:** none — mechanism/judgment post, no factcheck gate. The "twenty milliseconds inside five minutes" line is arithmetic, not a sourced statistic.
