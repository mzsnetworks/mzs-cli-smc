# Master — segment-iot-without-forklift

**Preset:** Business (MZS company account — LI page, FB, IG, X)
**Date:** 2026-09-09 (Wed)
**Source idea:** ideas-2026-07-16 #3 (IoT · How-to)
**Thesis:** Segmentation is an inventory plus a decision about who talks to whom. Thirty days, routed VLANs, ACLs you already own.
**Series:** direct sequel to `iot-inventory-not-security` (2026-08-19), which ended on "go count your MACs."
**Stats:** none — method/judgment post, no factcheck gate.
