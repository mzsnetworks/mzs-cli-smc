...
Operationally, this is the brownfield tax. A greenfield box has no history to contradict you. A ten-year-old production device carries the residue of every prior change window, and most of it is invisible until the one operation that depends on it fails.
