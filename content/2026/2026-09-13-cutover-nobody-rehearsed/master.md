# Master — cutover-nobody-rehearsed

**Preset:** Business (MZS company account — LI page, FB, IG, X)
**Date:** 2026-09-13 (Sun)
**Source idea:** ideas-2026-08-09 #6 (LP · Story)
**Thesis:** Everything before the cutover is tested in pieces. The cutover is the only integration test, and it runs once, in production, on a clock.
**Note:** kept off the checklist ground of `change-window-checklist` (2026-08-12) — this is about rehearsal as a test, and what rehearsal surfaces. "One named decision-maker" deliberately not reused.
