# LinkedIn — postmortems-are-code-review
...
Operationally, two rituals are converging into one discipline. Code review inspects a change for how it might fail. A postmortem inspects a change for how it did. Same activity, different tense.
...
Sources: Google, Site Reliability Engineering (O'Reilly, 2016), Introduction — sre.google/sre-book/introduction. DORA, Generative organizational culture — dora.dev/capabilities/generative-organizational-culture.

#SRE #NetDevOps #Postmortem
