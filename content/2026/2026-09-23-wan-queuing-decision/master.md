# Master — wan-queuing-decision

**Preset:** Business (MZS company account — LI page, FB, IG, X)
**Date:** 2026-09-23 (Wed)
**Source idea:** ideas-2026-08-30 #1 (ENO · Contrarian)
**Thesis:** Bandwidth is a purchase. Priority is a decision. Most "slow WAN" tickets are an unmade decision about what gets to wait.
**Note:** kept off the averaging/microburst ground of `bandwidth-graph-lies` (2026-09-06) — this is about queuing policy, not measurement.
**Stats:** none — mechanism/judgment post, no factcheck gate.
