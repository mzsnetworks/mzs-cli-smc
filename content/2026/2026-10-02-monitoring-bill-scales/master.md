# Master — monitoring-bill-scales

**Preset:** Business (MZS company account — LI page, FB, IG, X)
**Date:** 2026-10-02 (Fri)
**Source idea:** ideas-2026-08-30 #24 (ES · Observation)
**Thesis:** Monitoring cost scales with volume; understanding doesn't. The engineering is in deciding what not to collect.
**Note:** kept off `nobody-trusts-alerts` (2026-08-02, trust) and `single-pane-museum` (2026-09-03, dashboards vs work). This one is about cost and attention.
