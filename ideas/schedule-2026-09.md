...
**Parked to avoid repeating scheduled posts:**
- `08-09 #2` (the firewall rule nobody can delete) — Aug 27's `brownfield-is-a-negotiation` uses the same anecdote.
- `08-09 #6` (the cutover nobody rehearsed) — too close to Aug 30's `lab-failure-modes`.
- `07-11 #8` (the reason lives in one person's head) — same collision as #2; returned to pool from the missed Aug 23 slot.

Revisit all three once a few weeks separate them from the Aug 27–30 batch.
