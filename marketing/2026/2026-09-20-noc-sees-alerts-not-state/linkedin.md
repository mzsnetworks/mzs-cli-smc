...
And the gap is not a tooling problem, it is a question problem. An event system answers "what broke?" A state system answers "what is there?" The second question is the one audits ask, and contract renewals, and anyone in finance — and it is precisely the one nobody instrumented.
