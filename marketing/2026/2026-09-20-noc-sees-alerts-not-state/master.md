...
The consequence is subtle. Teams get very good at reacting and stay blind to accumulation: the image versions drifting apart, the circuit nobody cancelled, the change that was fine on its own and less fine combined with the other two that week.
